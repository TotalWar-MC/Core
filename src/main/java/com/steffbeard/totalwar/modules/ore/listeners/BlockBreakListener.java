package com.steffbeard.totalwar.modules.ore.listeners;
...
import com.steffbeard.totalwar.modules.ore.config.ToolConfig;
import com.steffbeard.totalwar.modules.ore.config.VeinConfig;
import com.steffbeard.totalwar.modules.ore.events.HiddenOreEvent;
import com.steffbeard.totalwar.modules.ore.events.HiddenOreGenerateEvent;
...
public class BlockBreakListener implements Listener {
	...
	private void doBlockBreak(BlockBreakEvent event) {
		...
		if (bc != null && bc.shouldSuppressDrops()) {
	...
	private void doActualGenerate(final List<ItemStack> items, final Location sourceLocation, final Player player,
			String dropName, String blockName, BlockConfig blockConfig, byte blockSubType, StringBuffer alertBuffer, DropConfig dropConfig) {
		int maxWalk = 0;
		int cPlace = 0;
		double cAttempt = 0;
