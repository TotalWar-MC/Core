...
public class ConnectionPool {
	 ...
	 * @param poolSize The maximum size of the connection pool (< 10 recommended)
	 * @param connectionTimeout The longest a query can run until timeout occurs (1-5s recommended)
	 * @param idleTimeout The longest a connection can sit idle before recycling (10min recom. check dbms config)
	 * @param maxLifetime The absolute longest length of time a connection can exist (2hr recom. check dbms config)
	 */
	public ConnectionPool(Logger log, String user, String pass, String host, int port, String database,
